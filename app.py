...
@st.cache_resource
def load_cnn_model():
    MODEL_PATH = r"C:\Users\MANIKANTA\Downloads\ai project aadhar\document_authentication_model.h5"  # ✅ Fixed path
...
def extract_fields(text):
    ...
    # Step 2: Aadhaar number — tolerate OCR issues like merged digits
    ...
    # Step 4: Name — flexible regex (handles OCR like HaNa, Hame, Namee, etc.)
